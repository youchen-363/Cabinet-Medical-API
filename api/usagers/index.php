    ...
    switch ($http_method){
        case "GET" :
            ...
            if(isset($_GET['id'])) {
                ...
                $meds = getUsagersByIdAPI($linkpdo,$id);
            } else {
                $meds = getAllUsagersAPI($linkpdo);
            }
            deliver_response(200, "Données récupérées avec succès", $meds);   
        break;
        ...
        case "POST" :
            ...
            if ($data === null) {
                ...
                $res = insertUsagerAPI($linkpdo, $data);
                // createChunkFact($linkpdo, $data['phrase']);
                deliver_response(201, "Données créées avec succès.", $res);
            }
        break;
